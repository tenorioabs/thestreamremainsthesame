source("V4_099_instala_carrega_pacotes.R")
source("V4_098_funcoes.R")
source("V4_001_download_concatenacao_urls.R")
#tabula_group_title("minha_lista.m3u8")
source("V4_002_cria_music_salva_arquivo.R")
source("V4_003_insere_canais_manualmente_concatena_resultados_buscados.R")
source("V4_004_cria_index_epg_no_m3u8.R")
source("V4_005_cria_grupos.R")
tabula_group_title("minha_lista_concatenada.m3u8")
#source("V4_006_double_check_canais.R")
source("V4_007_atribui_logo_remove_repetidos.R")
source("V4_008_testa_links_m3u8.R")
source("V4_009_cria_xml.R")
