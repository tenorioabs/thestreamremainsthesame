...
arquivo_entrada <- "minha_lista_concatenada.xml"
arquivo_saida <- "minha_lista_concatenada.xml.gz"

# Lê o conteúdo do arquivo de entrada
conteudo <- readLines(arquivo_entrada)

# Abre o arquivo de saída em modo de escrita e compactação
con <- gzfile(arquivo_saida, "w")

# Escreve o conteúdo no arquivo de saída, compactando-o no processo
writeLines(conteudo, con)

# Fecha a conexão com o arquivo
close(con)

# Mensagem de conclusão
cat("Arquivo '", arquivo_entrada, "' foi compactado e salvo como '", arquivo_saida, "'.\n", sep = "")
