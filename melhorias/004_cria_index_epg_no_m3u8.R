...
if (grepl("^#EXTM3U", linhas[1])) {
  linhas[1] <- gsub('x-tvg-url="[^"]+"', 'x-tvg-url="https://github.com/tenorioabs/thestreamremainsthesame/raw/main/final/minha_lista_concatenada_ativa.xml.gz"', linhas[1], perl = TRUE)
}
